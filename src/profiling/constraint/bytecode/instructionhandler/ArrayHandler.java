				...
				else 
				{
					...
					else
					{
						...
						if (isStoreInstruction(currentInstruction)){			   																			
							...
							if (!(evar instanceof StaticClass || evar instanceof NewArray || evar instanceof Variable || evar instanceof ArrayElement || evar instanceof MethodCall)){
								...
								if (CFGBuilder.elementStack.isEmpty())
									System.out.println(evar+ "   type: " + evar.getClass());
								
								if (CFGBuilder.elementStack.isEmpty())
								{
									System.out.println("");
									System.out.println("  Exception na classe: " + cfg.getClassName());
									System.out.println("");
								}
